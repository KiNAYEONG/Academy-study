...
<body>
	...
	<script type="text/javascript">
			...
			$
					.each(
							...
							function(index, vo) {
								...
								listHtml += "<td id='t"+vo.idx+"'><a href='javascript:goContent("
										+ vo.idx + ")'>";
								listHtml += vo.title + "</a></td>";
								listHtml += "<td id='w"+vo.idx+"'>" + vo.writer
										+ "</td>";
								...
								listHtml += "<button onclick='goUpdate("
										+ vo.idx
										+ ")' class='btn btn-warning'>수정화면</button>&nbsp;";
								listHtml += "</span>";
		...
		function goInsert() {
			// title="안녕"&content="반가워"&wrtier="박병관"
		...
		function goUpdate(idx) {
			...
			let nButton = "<button onclick='goUpdatedo(" + idx
